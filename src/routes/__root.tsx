...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${SITE.name} — Loans, Mortgage & Insurance` },
      { name: "description", content: "Trusted finance partner for home, business, personal, vehicle and education loans, mortgage, insurance and auction property assistance." },
      { property: "og:site_name", content: SITE.name },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: `${SITE.name} — Loans, Mortgage & Insurance` },
      { name: "twitter:title", content: `${SITE.name} — Loans, Mortgage & Insurance` },
